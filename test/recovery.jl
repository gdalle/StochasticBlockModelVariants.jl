...
for Pʷ in (GaussianWeightPrior(), RademacherWeightPrior())
    test_recovery(GLMSBM(; N=10^3, M=10^3, c=5, λ=2, ρ=0.0, Pʷ))  # AMP-BP
    test_recovery(GLMSBM(; N=10^2, M=10^2, c=5, λ=2, ρ=0.5, Pʷ))  # semi-supervised
end
